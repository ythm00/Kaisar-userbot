...
KANGING_STR = [
    "Mengambil Sticker Ini Ke Pack Kaisar",
    "Kaisar Mengambil Sticker Ini Ke Pack",
]
...
async def kang(args):
    ...
    if message and message.media:
        if isinstance(message.media, MessageMediaPhoto):
            ...
            return await args.edit("`File Tidak Didukung Kaisar!`")
    else:
        return await args.edit("`Maaf Kaisar, Saya Gagal Mengambil Sticker Ini!`")
    ...
    if photo:
        ...
        if (
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                while "120" in x.text:
                    ...
                    if x.text == "Gagal Memilih Pack.":
                        ...
                        return await args.edit(
                            ...
                            f"┍━━☽【❖】☾━━┑\n    [🐿TEKAN SINI](t.me/addstickers/{packname})\n┕━━☽【❖】☾━━┙\n**Untuk Melihat Sticker Kaisar**",
                            parse_mode="md",
                        )
                if is_anim:
                    await conv.send_file("AnimatedSticker.tgs")
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Maaf Kaisar, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker Anda.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
            ...
            async with bot.conversation("Stickers") as conv:
                ...
                if "Sorry, the file type is invalid." in rsp.text:
                    return await args.edit(
                        "`Mohon Maaf Kaisar, Saya Gagal Menambahkan Sticker, Gunakan` @Stickers ` Bot Untuk Menambahkan Sticker.`"
                    )
                await conv.send_message(emoji)
                # Ensure user doesn't get spamming notifications
                await bot.send_read_acknowledge(conv.chat_id)
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack**\n ┍━━☽【❖】☾━━┑\n    [🐿TEKAN SINI](t.me/addstickers/{packname})\n┕━━☽【❖】☾━━┙\n**Untuk Melihat Pack Anda**",
            parse_mode="md",
        )
...
async def sticker_to_png(sticker):
    ...
    try:
        ...
        await sticker.edit("`Maaf Kaisar, Ini Bukanlah Sticker`")
        return
