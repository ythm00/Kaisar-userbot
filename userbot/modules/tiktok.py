...
async def _(event):
    ...
    if ".com" not in d_link:
        await event.edit("`Mohon Maaf Kaisar, Saya Membutuhkan Link Video Tiktok Untuk Download Video Tiktok` **(._.)**")
    else:
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            await event.edit("**Kesalahan:** `Kaisar Mohon Buka Blokir` @ttsavebot `Dan Coba Lagi!`")
            return
