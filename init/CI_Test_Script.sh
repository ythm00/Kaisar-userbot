...
tg_sendinfo "<code>I am gonna merge staging into Kaisar-userbot</code>"
cd
...
git push --force origin staging:Kaisar-userbot
tg_sendinfo "<code>I have merged all commits from staging into Kaisar-userbot</code>"
